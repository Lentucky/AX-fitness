...
<div class="container">
<h1 class="white-text">You are currently in Branch: <?php echo $branchName?></h1>
    ...
    <?php 
            ...
            $sql = "SELECT * 
                    ...
                    WHERE customer.Branch_ID = $subBranch ORDER BY Date_due";
                //Execute the Query
            //Execute the Query
                ...
                if($count>0)
                {
                    ...
                    while($rows=mysqli_fetch_assoc($res))
                    {
                        ...
                        <tr>
                            ...
                            if($isPaid=="Pending"){
                                ?>
                            <td><a class="btn btn-primary" href="update-pending.php?id=<?php echo $customer_id; ?>" role="button">Pending</a></td>
                            <?php }else{ ?>
