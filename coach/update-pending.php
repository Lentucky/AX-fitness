...
<div class="container">
    ...
    <div class="gallery">
        ...
        <?php 
                ...
                $id = $_GET['id'];
                $sql = "SELECT * FROM transactions WHERE Customer_ID = $id ORDER BY transaction_ID DESC LIMIT 1";
                    ...
                    if($count>0)
                    {
                        ...
                        while($rows=mysqli_fetch_assoc($res))
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-success" href="update-status-paid.php?id=<?php echo $Customer_ID; ?>" role="button">Confirm</a>
                                    <a class="btn btn-danger" href="update-status-unpaid.php?id=<?php echo $Customer_ID; ?>" role="button">Decline</a>
                                </td>
                        </tr>
